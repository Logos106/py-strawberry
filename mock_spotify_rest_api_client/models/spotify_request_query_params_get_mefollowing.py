from typing import cast, Any, Dict, Literal, Type, TypeVar, Union
...
class SpotifyRequestQueryParamsGETMefollowing:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        type = cast(Literal["artist"], d.pop("type"))
        if type != "artist":
            raise ValueError(f"type must match const 'artist', got '{type}'")
